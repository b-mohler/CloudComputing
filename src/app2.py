...
dynamodb = boto3.resource('dynamodb', endpoint_url='http://localstack:5000', region_name='us-east-1')
s3 = boto3.client('s3', endpoint_url='http://localstack:5000', region_name='us-east-1')
